...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return DefaultTabController(
          ...
          body: Builder(
            builder: (context)=>
                TabBarView(
                  children: [
                    /* LOGIN IN */
                    loginScreen(_width, _height, context),
                    /* SIGN UP */
                    signUp(_width, _height, context)
                  ],
                ),
          ),
        ),
      ...
      //loginSignup(_secureText,_width,_height);
  }

  Widget loginScreen(double _width , double _height,BuildContext context)
  {
    return Padding(
  ...
  Widget signUp(double _width , double _height,BuildContext context )
  {
    return Padding(
      padding: const EdgeInsets.all(10.0),
      child: SingleChildScrollView(
