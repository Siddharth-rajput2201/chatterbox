...
class UniversalColorVariables
{
  static final Color darkBackGroundColor = Color(0xff303030);
  static final Color backGroundColor = Color(0xff313D5A);
  static final Color blackColor = Color(0xff303030);
  static final Color blueColor = Color(0xff2b9ed4);
  static final Color darkBlackColor = Color(0xff19191b);
